...
public class CasUserDetailsAuthenticationProvider implements AuthenticationProvider,
     ...
     *
     * @param assertion
     * @date 2021-03-01 19:05:01
     * @return	org.springframework.security.core.userdetails.UserDetails
     * @exception
     */
    protected UserDetails loadUserByAssertion(final Assertion assertion) {
        CasUsernamePasswordAuthenticationToken token = new CasUsernamePasswordAuthenticationToken(assertion.getPrincipal().getName(),"");
