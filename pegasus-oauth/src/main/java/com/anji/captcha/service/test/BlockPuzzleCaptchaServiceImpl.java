...
public class BlockPuzzleCaptchaServiceImpl extends AbstractCaptchaService {
    ...
    public ResponseModel get(CaptchaVO captchaVO) {
        ...
        try {
            originalImage = ImageIO.read(new File("C:\\Users\\Administrator\\Desktop\\1716519899102.jpg"));
        } catch (IOException e) {
        ...
        //抠图图片
        BufferedImage jigsawImage = null;
        try {
            jigsawImage = ImageIO.read(new File("C:\\Users\\Administrator\\Desktop\\1.png"));
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
        InputStream is = null;
        ...
        try {
             is = new FileInputStream(new File("C:\\Users\\Administrator\\Desktop\\1.png"));
        ...
        String jigsawImageBase64 = null;
        try {
            jigsawImageBase64 = new String(Base64.getEncoder().encode(byteArrayOutputStream.toByteArray()), "utf-8");
