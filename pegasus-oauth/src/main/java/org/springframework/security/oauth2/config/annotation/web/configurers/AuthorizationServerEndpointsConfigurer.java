...
/**
 * Created by enHui.Chen on 2021/3/16.
 */
public final class AuthorizationServerEndpointsConfigurer {
    ...
    private List<AuthorizationPostProcessor> authorizationPostProcessors = Collections.emptyList();
    ...
    public List<AuthorizationPostProcessor> getAuthorizationPostProcessors() {
        return authorizationPostProcessors;
    }

    public AuthorizationServerEndpointsConfigurer setAuthorizationPostProcessors(List<AuthorizationPostProcessor> authorizationPostProcessors) {
        if (!CollectionUtils.isEmpty(authorizationPostProcessors)) {
            this.authorizationPostProcessors = authorizationPostProcessors;
            this.authorizationPostProcessors.sort(Comparator.comparing(AuthorizationPostProcessor::getOrder));
        }
        return this;
    }
}
