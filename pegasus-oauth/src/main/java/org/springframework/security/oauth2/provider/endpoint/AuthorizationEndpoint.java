...
public class AuthorizationEndpoint extends AbstractEndpoint {
    ...
    private List<AuthorizationPostProcessor> authorizationPostProcessors = new ArrayList<>();
    ...
    private ModelAndView getImplicitGrantResponse(AuthorizationRequest authorizationRequest) {
        try {
            ...
            // 自定义授权post处理器
            authorizationPostProcessors.forEach(processor -> processor.process(request, null, accessToken));
    ...
    public void setAuthorizationPostProcessors(List<AuthorizationPostProcessor> authorizationPostProcessors) {
