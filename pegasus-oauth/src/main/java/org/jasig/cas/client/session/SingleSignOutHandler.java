...
public final class SingleSignOutHandler {
    ...
    private List<CasSignInPostProcessor> casSignInProcessors;

    private List<CasSignOutPostProcessor> casSignOutProcessors;
    ...
    private void recordSession(final HttpServletRequest request) {
        ...
        // 登录成功处理
        for (CasSignInPostProcessor casSignInPostProcessor : casSignInProcessors) {
            casSignInPostProcessor.process(request, null);
        }
    ...
    private void destroySession(final HttpServletRequest request) {
        ...
        if (CommonUtils.isNotBlank(token)) {
            ...
            // 登出处理
            for (CasSignOutPostProcessor casSignOutPostProcessor : casSignOutProcessors) {
                casSignOutPostProcessor.process(request, null, token);
            }
        }
    }
    ...
    public List<CasSignInPostProcessor> getCasSignInProcessors() {
        return casSignInProcessors;
    }

    public void setCasSignInProcessors(List<CasSignInPostProcessor> casSignInProcessors) {
        this.casSignInProcessors = casSignInProcessors;
    }

    public List<CasSignOutPostProcessor> getCasSignOutProcessors() {
        return casSignOutProcessors;
    }

    public void setCasSignOutProcessors(List<CasSignOutPostProcessor> casSignOutProcessors) {
        this.casSignOutProcessors = casSignOutProcessors;
    }
}
